...
/**
 * A <code>CanvasImageParticleTest</code> is a simple JavaFX application to test
 * <code>Canvas<code> rendering with a large number of particles in the form of scaled images.
 * 
...
public class CanvasImageParticleTest extends Application {
	...
	public void start(final Stage stage) {
		...
		stage.setTitle("JavaFX Canvas Image Particle Test"); //$NON-NLS-1$

		// Create a new particle tester using an image renderer.
